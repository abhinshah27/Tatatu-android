...
abstract class BaseAndroidViewModel(application: Application): AndroidViewModel(application), DisposableHandler by CompositeDisposableHandler(), OnServerMessageReceivedListener, KoinComponent {
