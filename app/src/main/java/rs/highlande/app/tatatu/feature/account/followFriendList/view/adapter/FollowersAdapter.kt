...
class FollowersAdapter(clickListener: BaseFollowFragment.FollowClickListener):
    BaseRecViewAdapter<User, BaseFollowFragment.FollowClickListener, FollowersAdapter.FollowersViewHolder>(clickListener) {
    ...
    class FollowersViewHolder(val itemBinding: FollowListItemBinding): BaseViewHolder<User, BaseFollowFragment.FollowClickListener>(itemBinding.root) {
        ...
        override fun onBind(item: User, listener: BaseFollowFragment.FollowClickListener?) {
            with(itemBinding) {
                listener?.let { listener ->
                    ...
                    followerAvatar.followerTTUBalanceTextView.visibility = View.VISIBLE
                    followerAvatar.followerTTUBalanceTextView.text = formatTTUTokens(item.balanceInfo.balance)
