...
class OnBoardingFragment : BaseFragment() {
    ...
    private fun setUI(imgUrl: Int = R.drawable.ic_better_than_free_illustration, title: String = resources.getString(R.string.title_welcome), subTitle: String = resources.getString(R.string.sub_title_choose_from)) {
